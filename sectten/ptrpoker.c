/* Reads, analyzes, and then prints poker hand with functions that are passed pointers */
#include <stdio.h>
...
int main(void) {
	int num_in_rank[NUM_RANKS], num_in_suits[NUM_SUITS];
...
/*
* read_card: reads the cards into the array arguments, num_in_rank and num_in_suit.
...
void read_cards(int num_in_rank[], int num_in_suit[]) {
	...
	while(cards_read < NUM_CARDS) {
		...
		if (bad_card) printf("Bad_card; ignored\n");
...
*				  determines the number of pairs; stores the results into the pointers straight, flush, four, three, and
*				  pairs.
*/
...
/*
*	print_result: Prints the classification of the hand, based on values the pointers straight flush, four, three, and pairs
*				  point to;
*/
void print_result(const bool *straight, const bool *flush, const bool *four, const bool *three, const int *pairs) {
